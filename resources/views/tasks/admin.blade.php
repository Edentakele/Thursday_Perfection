...
<div class="container mx-auto px-4">
    <div class="py-8">
        ...
        <a href="{{ route('tasks.create') }}" class="inline-block bg-blue-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-blue-600 transition duration-300 ease-in-out mb-4">Create Task</a>
        <ul>
